...
test('API Login flow for coolab.ai', async ({ page }) => {
  ...
  await page.goto('https://ucl-coolab-dev.uk.r.appspot.com/modal/log-in/');
  ...
  const preLoginResponse = await page.request.post('https://ucl-coolab-dev.uk.r.appspot.com/modal/log-in/', {
    headers: {
  ...
  const loginResponse = await page.request.post('https://ucl-coolab-dev.uk.r.appspot.com/modal/log-in/', {
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded',
      'Referer': 'https://ucl-coolab-dev.uk.r.appspot.com/modal/log-in/',
      'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.131 Safari/537.36'
